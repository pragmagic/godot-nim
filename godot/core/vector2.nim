...
proc toGodotString*(self: Vector2): GodotString {.
    importc: "godot_vector2_as_string", header: "godot/vector2.h".}
proc `$`*(self: Vector2): string {.inline.} =
  $self.toGodotString()

proc normalized*(self: Vector2): Vector2 {.
    importc: "godot_vector2_normalized", header: "godot/vector2.h".}
...
proc `+`*(a, b: Vector2): Vector2 {.
    importc: "godot_vector2_operator_add", header: "godot/vector2.h".}
proc `+=`*(a: var Vector2, b: Vector2) {.inline.} =
  a += b

proc `-`*(a, b: Vector2): Vector2 {.
    importc: "godot_vector2_operator_substract", header: "godot/vector2.h".}
proc `-=`*(a: var Vector2, b: Vector2) {.inline.} =
  a = a - b
...
proc `/`*(a, b: Vector2): Vector2 {.
    importc: "godot_vector2_operator_divide_vector", header: "godot/vector2.h".}
proc `/=`*(a: var Vector2, b: Vector2) {.inline.} =
  a = a / b

proc `/`*(self: Vector2; scalar: float32): Vector2 {.
    importc: "godot_vector2_operator_divide_scalar", header: "godot/vector2.h".}
proc `/=`*(self: var Vector2; scalar: float32) {.inline.} =
  self = self / scalar

proc `==`*(a, b: Vector2): bool {.
    importc: "godot_vector2_operator_equal", header: "godot/vector2.h".}
proc `<`*(a, b: Vector2): bool {.
...
proc `x=`*(self: var Vector2; x: float32) {.
    importc: "godot_vector2_set_x", header: "godot/vector2.h".}
proc `y=`*(self: var Vector2; y: float32) {.
    importc: "godot_vector2_set_y", header: "godot/vector2.h".}
proc x*(self: Vector2): float32 {.
    importc: "godot_vector2_get_x", header: "godot/vector2.h".}
proc y*(self: Vector2): float32 {.
    importc: "godot_vector2_get_y", header: "godot/vector2.h".}
